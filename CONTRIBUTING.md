...
|----------------------------------------------|------------------------------------------|
| `autoload/nvcode.vim`                       | `build/templates/autoload.template.vim`  |
...
For the "Language-Specific Highlighting" portion of nvcode.vim, blocks for each language should be organized alphabetically ("Markdown" comes before "PHP").
...
Thanks very much for contributing to nvcode.vim!
